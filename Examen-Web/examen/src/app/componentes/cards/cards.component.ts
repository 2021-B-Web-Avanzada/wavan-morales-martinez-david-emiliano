...
export class CardsComponent implements OnInit {
  ...
  arregloCards = [
    {
      icono: 'M14 20a1 1 0 0 1 1-1h66a1 1 0 0 1 1 1v47a1 1 0 0 1-1 1H29.657a7 7 0 0 0-4.95 2.05l2.121 2.122-2.12-2.122L14 80.757V20z',
      icono2: 'M29 55h38M29 43h38M29 31h38',
      icono3: '',
      width: '6',
    ...
    {
      icono: 'M79.684 22.929H16.946c-3.353 0-6.072 2.878-6.072 6.428v42.857c0 3.55 2.719 6.429 6.072 6.429h62.738c3.353 0 6.072-2.878 6.072-6.429V29.357c0-3.55-2.719-6.428-6.072-6.428z',
      icono2: 'M48.315 61.521c5.6 0 10.14-4.806 10.14-10.735 0-5.93-4.54-10.736-10.14-10.736-5.6 0-10.14 4.806-10.14 10.736 0 5.929 4.54 10.735 10.14 10.735z',
      icono3: 'M40.22 20.857v-2.143c0-1.705-.64-3.34-1.779-4.545-1.138-1.206-2.682-1.883-4.293-1.883h-4.047c-1.61 0-3.155.677-4.293 1.883-1.139 1.205-1.779 2.84-1.779 4.545v2.143',
      width: '4',
      titulo: 'Visitas',
